...
class BenchmarkAnalyzer:
    def __init__(self, sort_function: Callable[[List[int]], List[int]], first_n_lists: int = None):
    ...
    def _print_final_results(df):
        ...
        df['elapsed_time_rel_diff'] = df['elapsed_time'][method_name] / df['elapsed_time']['py_sort'] - 1
        df['cpu_time_rel_diff'] = df['cpu_time'][method_name] / df['cpu_time']['py_sort'] - 1
        df['memory_usage_rel_diff'] = df['memory_usage'][method_name] / df['memory_usage']['py_sort'] - 1
        ...
        final_averages = df[['elapsed_time_rel_diff', 'cpu_time_rel_diff', 'memory_usage_rel_diff']].mean(numeric_only=True)
